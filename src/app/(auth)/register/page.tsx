  ...
  return (
    <div className="flex flex-col items-center space-y-8">
      ...
      <div className="w-full space-y-6 rounded-sm bg-[#181818] p-10 text-white shadow-2xl ring-1 ring-white/5">
        ...
        <p className="text-center text-xs font-medium text-[#999999]">
          E-postanla kaydol
        </p>
        ...
        <form action={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center gap-2">
             <input type="checkbox" required id="terms" className="h-4 w-4 rounded border-white/10 bg-[#2b2b2b] text-[#ff4655] focus:ring-[#ff4655]" />
             <label htmlFor="terms" className="text-xs font-medium text-white/60">Kullanım koşullarını kabul ediyorum</label>
          </div>
          ...
          >
            {loading ? (
              ...
              <span className="text-sm font-bold text-white">KAYIT OL</span>
            )}
          </button>
        </form>
